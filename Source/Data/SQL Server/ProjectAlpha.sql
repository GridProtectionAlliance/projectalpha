--  ----------------------------------------------------------------------------------------------------
--  ProjectAlpha Data Structures for SQL Server - Gbtc
--
...
--       Script is based on ProjectAlpha.sql script created by James Ritchie Carroll.
...
GO
ALTER DATABASE [ProjectAlpha] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [ProjectAlpha] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [ProjectAlpha] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [ProjectAlpha] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [ProjectAlpha] SET ARITHABORT OFF 
GO
ALTER DATABASE [ProjectAlpha] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [ProjectAlpha] SET AUTO_CREATE_STATISTICS ON 
GO
ALTER DATABASE [ProjectAlpha] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [ProjectAlpha] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [ProjectAlpha] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [ProjectAlpha] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [ProjectAlpha] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [ProjectAlpha] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [ProjectAlpha] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [ProjectAlpha] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [ProjectAlpha] SET  ENABLE_BROKER 
GO
ALTER DATABASE [ProjectAlpha] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [ProjectAlpha] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [ProjectAlpha] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [ProjectAlpha] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [ProjectAlpha] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [ProjectAlpha] SET  READ_WRITE 
GO
ALTER DATABASE [ProjectAlpha] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [ProjectAlpha] SET  MULTI_USER 
GO
ALTER DATABASE [ProjectAlpha] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [ProjectAlpha] SET DB_CHAINING OFF 
GO
-- The next three commented statements are used to create a user with access to the ProjectAlpha database.
...
--GO
--CREATE ROLE [ProjectAlphaManagerRole] AUTHORIZATION [dbo]
--GO
--EXEC sp_addrolemember N'ProjectAlphaManagerRole', N'NewUser'
--GO
--EXEC sp_addrolemember N'db_datareader', N'ProjectAlphaManagerRole'
--GO
--EXEC sp_addrolemember N'db_datawriter', N'ProjectAlphaManagerRole'
--GO
