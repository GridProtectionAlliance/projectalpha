--  ----------------------------------------------------------------------------------------------------
--  ProjectAlpha Data Structures for MySQL - Gbtc
--
...
CREATE DATABASE ProjectAlpha CHARACTER SET = UTF8;
USE ProjectAlpha;
...
-- GRANT SELECT, UPDATE, INSERT, DELETE ON ProjectAlpha.* TO NewUser;
