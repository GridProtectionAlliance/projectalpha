...
namespace ConfigurationSetupUtility
{
    ...
    public class SqlServerSetup
    {
        ...
        public void GrantDatabaseAccess(string loginName)
        {
            ...
            ExecuteStatement("IF DATABASE_PRINCIPAL_ID('ProjectAlphaAdminRole') IS NULL CREATE ROLE [ProjectAlphaAdminRole] AUTHORIZATION [dbo]");
            ExecuteStatement(string.Format("IF DATABASE_PRINCIPAL_ID('{0}') IS NOT NULL AND DATABASE_PRINCIPAL_ID('ProjectAlphaAdminRole') IS NOT NULL EXEC sp_addrolemember N'ProjectAlphaAdminRole', N'{0}'", loginName));
            ExecuteStatement(string.Format("IF DATABASE_PRINCIPAL_ID('ProjectAlphaAdminRole') IS NOT NULL EXEC sp_addrolemember N'db_datareader', N'ProjectAlphaAdminRole'"));
            ExecuteStatement(string.Format("IF DATABASE_PRINCIPAL_ID('ProjectAlphaAdminRole') IS NOT NULL EXEC sp_addrolemember N'db_datawriter', N'ProjectAlphaAdminRole'"));
        }
