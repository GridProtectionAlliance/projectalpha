...
SET pwd="%CD%"
SET gwd="%LOCALAPPDATA%\Temp\ProjectAlpha"
...
SET targettools=Source\Applications\ProjectAlpha\ProjectAlphaSetup\
...
MOVE /Y "%sourceschema%\Oracle\*.*" "%targetschema%\PostgreSQL\"
